...
const DEFAULT_CONFIG: Record<string, Record<RoleType, boolean>> = {
  ...
  '/companies':           { morador: false, sindico: false, administradora: false, programador: true, administrador: true },
  '/complexes':           { morador: false, sindico: false, administradora: false, programador: true, administrador: true },
  '/blocks':              { morador: false, sindico: false, administradora: false, programador: true, administrador: true },
  '/apartments':          { morador: false, sindico: false, administradora: false, programador: true, administrador: true },
  '/meters':              { morador: false, sindico: false, administradora: false, programador: true, administrador: true },
  ...
  '/reservoirs':          { morador: false, sindico: false, administradora: false, programador: true, administrador: true },
